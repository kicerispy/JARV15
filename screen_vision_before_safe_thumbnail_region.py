...
def locate_youtube_thumbnail(
    ...
    # --------------------------------------------------
    # Conservative deterministic thumbnail region.
    #
    ...
    #
    # Do not depend on the vision model's thumbnail box
    # or on thumbnail aspect ratio. YouTube Music / Art
    # Track thumbnails do not always match the assumed
    # 16:9 geometry inside the detected row.
    #
    # Keep the clickable region firmly on the left side
    # of the verified row.
    # --------------------------------------------------
    ...
    if (
        ...
        logging.info(
            f"YouTube conservative thumbnail "
            f"candidate {candidate_index}: "
            "region too narrow: "
    ...
    # --------------------------------------------------
    # Extra horizontal safety margin.
    #
    # The right edge of the clickable region must remain
    # well inside the left half of the verified row.
    # --------------------------------------------------
    ...
    if (
        ...
        thumbnail_right = horizontal_limit
