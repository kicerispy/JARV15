...
def youtube_candidate_match_score(
    ...
    # Relevance policy
    #
    # Title and context are primary evidence.
    # Channel is supporting evidence only.
    #
    # A matching Topic channel by itself is NOT enough to
    # accept an arbitrary video from that channel.
    # ------------------------------------------------------
