...
def youtube_candidate_match_score(
    ...
    # IMPORTANT:
    #
    # Channel matching is still valid.
    #
    # However, a strong channel match by itself is no longer
    # automatically treated as a complete semantic match.
    #
    # This is important for queries such as:
    #
    #     "Wi-Fi skeleton"
    #
    # where the requested identity may be represented by the
    # YouTube Topic channel while individual video titles are
    # different.
    #
    # A channel match remains useful enough to pass the
    # candidate onward to the structural verifier, but title
    # or context matches receive priority.
    # ------------------------------------------------------
