...
class N8NAutostartTests(unittest.TestCase):
    ...
    def test_launch_uses_call_for_npx_cmd_paths_with_spaces(self):
        ...
        with (
            mock.patch.object(config, "N8N_ENABLED", True),
            ...
            mock.patch(
                "n8n_autostart.n8n_log_path",
                return_value=Path(config.BASE_DIR) / ".jarvis_runtime" / "test-n8n.log",
            ),
            ...
            mock.patch.object(n8n_autostart.threading, "Thread"),
        ):
