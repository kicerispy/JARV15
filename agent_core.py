    ...
    def execute_task(
        ...
        while True:
            ...
            if result == "failed":
                ...
                # Runtime code-defect handling already ran before the
                # generic retryability gate. Continue with the established
                # diagnostic/replan path when no safe source target was found.
